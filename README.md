...
[![Build Status](https://travis-ci.org/Vardot/varbase.svg?branch=8.x-6.2)](https://travis-ci.org/Vardot/varbase/builds/452558602) Varbase 8.6.2
...
```
composer create-project Vardot/varbase-project:^8.6.2 PROJECT_DIR_NAME --no-dev --no-interaction
```
