...
[![Build Status](https://travis-ci.org/Vardot/varbase.svg?branch=8.x-4.09)](https://travis-ci.org/Vardot/varbase/builds/279293084) Varbase 8.4.09
...
```
composer create-project Vardot/varbase-project:^8.4.09 PROJECT_DIR_NAME --no-dev --no-interaction
```
