...
[![Build Status](https://travis-ci.org/Vardot/varbase.svg?branch=8.x-5.2)](https://travis-ci.org/Vardot/varbase/builds/443844400) Varbase 8.5.2
...
```
composer create-project Vardot/varbase-project:^8.5.2 PROJECT_DIR_NAME --no-dev --no-interaction
```
