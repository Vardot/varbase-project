...
[![Build Status](https://travis-ci.org/Vardot/varbase.svg?branch=8.x-5.3)](https://travis-ci.org/Vardot/varbase/builds/449521528) Varbase 8.5.3
...
```
composer create-project Vardot/varbase-project:8.5.3 PROJECT_DIR_NAME --no-dev --no-interaction
```
