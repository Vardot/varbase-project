...
[![Build Status](https://travis-ci.org/Vardot/varbase.svg?branch=8.x-8.2)](https://travis-ci.org/Vardot/varbase/builds/646090016) Varbase 8.8.2
...
```
composer create-project Vardot/varbase-project:^8.8.2 PROJECT_DIR_NAME --no-dev --no-interaction
```
