...
[![Build Status](https://travis-ci.org/Vardot/varbase.svg?branch=8.x-7.5)](https://travis-ci.org/Vardot/varbase/builds/648083040) Varbase 8.7.5
...
```
composer create-project Vardot/varbase-project:^8.7.5 PROJECT_DIR_NAME --no-dev --no-interaction
```
