...
Follow with [Integration of Varbase with Storybook](https://docs.varbase.vardot.com/v/11.0.x/developers/theme-development-with-varbase/integration-of-varbase-with-storybook)
...
> is set up to point to the `"PROJECT_FOLDER/web"` directory.
