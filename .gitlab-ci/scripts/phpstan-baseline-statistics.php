...
/**
 * @file
 * PHPStan baseline statistics for Varbase.
 *
 * Generates statistics from a PHPStan baseline file and outputs them
 * in a format suitable for GitLab metrics.
 */
...
if (!file_exists($baselineFile)) {
  echo "PHPStan baseline file not found: $baselineFile\n";
  exit(2);
}
...
echo "----------------------------------------\n";
echo "PHPStan baseline statistics (Varbase)\n";
echo "----------------------------------------\n";
