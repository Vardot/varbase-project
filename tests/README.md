...
tests/
  features/
    varbase/
      # Ported from the Varbase profile Behat suite. Each folder is one parallel
      # CI suite (parallel: matrix over SUITE); it runs as
      # tests/features/varbase/$SUITE/**/*.feature.
      01-website-base-requirements/ # Welcome tour, registration, roles, input formats, languages, translation, a11y checker
      02-user-management/           # Request password, create/assign users, login, persistent login, user protect, role assign
      03-admin-management/          # Admin/dev pages, masquerade, keyboard nav, disable users, media list, JSON:API, responsive preview, audit trail, bulk upload
      04-content-structure/         # Basic page / landing (paragraphs + layout builder) / blog / homepage permissions, breadcrumbs, section configs
      05-content-management/        # Entityqueue, hero slider, cloning, media library embed, easy linking, workflows, planning/scheduling
