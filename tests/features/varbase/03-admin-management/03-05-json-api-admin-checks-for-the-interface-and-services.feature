  ...
  Scenario: Check Varbase API settings and Generate keys
    Given I am a logged in user with the "webmaster" user
     ...
     Then I should see "Varbase API settings"
      ...
      And the Drupal checkbox "bundle_docs" is checked
  ...
  Scenario: Check that Site Admin users can access "View JSON" and "View API Docs" entity operations
    Given I am a logged in user with the "Site admin" user
     ...
     Then I should see "Tags"
      ...
      And I should see the "View API Docs" operation for the "space" term
     ...
     Then I should see "Entityqueues"
      ...
      And I should see the "View API Docs" operation for the "Media Hero Slider" entity
      And I should see the "Edit items" operation for the "Media Hero Slider" entity
  @check @local @development @staging @production
  Scenario: Check that Content Admin users can not access "View JSON" and "View API Docs" entity operations
    Given I am a logged in user with the "Content admin" user
     ...
     Then I should see "Entityqueues"
      ...
      But I should see the "Edit items" operation for the "Media Hero Slider" entity
  @check @local @development @staging @production
