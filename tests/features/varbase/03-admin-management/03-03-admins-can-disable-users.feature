  ...
  Scenario: Check flood control default settings
    Given I am a logged in user with the "webmaster" user
     ...
     Then I should see "Flood control"
      ...
      And the option "1 hour" should be selected within the select element "#edit-ip-window"
      And I should see "5" in the "#edit-user-limit" element
      And the option "6 hours" should be selected within the select element "#edit-user-window"
  @local @development @staging @production
