Feature: Content Management - Content Planning and scheduling
  ...
  # TODO(10.1.x CI): the Content Planner dashboard widgets ("Content Status
  # Widget", ...) only render once the dashboard is configured; the classic
  # profile test install leaves it unconfigured ("Dashboard is not configured
  # yet"). Provision the dashboard in the CI before_script, then un-@wip.
