  ...
  Scenario: Add the Test Basic page root page to the main menu
    Given I am a logged in user with the "Site admin" user
     When I go to "/node/add/page"
      ...
      And I fill in the rich text editor field "Body" with the "Test Basic page root body"
  ...
  Scenario: Add the Test Basic page sub 1, then check the breadcrumb
    Given I am a logged in user with the "Site admin" user
     When I go to "/node/add/page"
      ...
      And I fill in the rich text editor field "Body" with the "Test Basic page sub 1 body"
      And I expand the field "edit-menu"
      And wait
      And I check "Provide a menu link"
