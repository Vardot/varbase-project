...
Feature: Content Structure - Change section settings in Landing Pages with Layout Builder
  ...
  Scenario: Check if a site admin can create a landing page and add sections to it with different container types
    Given I am a logged in user with the "Site admin" user
     ...
     Then I should see "With Gutters"
     ...
     When I click "Add block in Section 2, Col 1 region"
      ...
      And I wait for AJAX to finish
      And I check "Display title"
      And I fill in "Test Rich text in 2 cols section, col 1" for "Title"
      And I fill in the rich text editor field "Body" with the "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer aliquet diam nunc, ac dictum velit tincidunt quis. Integer ut imperdiet dui, sit amet tempus est. Curabitur molestie sem non purus dignissim pulvinar. Pellentesque id sapien consequat"
