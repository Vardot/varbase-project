  ...
  Scenario: Check if inserted raw URL will convert into a link using the "Rich editor" text format when we save a new Basic page
    Given I am a logged in user with the "Site admin" user
     ...
     When I select "full_html" from "Text format"
      And I fill in "Title" with "Test convert URLs"
      And I fill in the rich text editor field "Body" with the "<p>Test line #1 <br /> Test line #2 http://drupal.org <br /> Test line #3</p>"
     Then I press "Save"
      And wait
