Feature: Website Base Requirements - Website Languages - English
  ...
  Scenario: Check if a content admin user can Create Basic page with English for the language of the content
    Given I am a logged in user with the "Content admin" user
      ...
      And wait
     When I select "English" from "#edit-langcode-0-value"
     Then I should see "Language"
     When I select "English" from "#edit-langcode-0-value"
      And I fill in "Title" with "Test English Basic page title by content admin"
  ...
  Scenario: Check if a content admin user can Create Landing page with English for the language of the content
    Given I am a logged in user with the "Content admin" user
      And I go to "/node/add/landing_page_lb"
      And wait
     When I select "English" from "#edit-langcode-0-value"
     Then I should see "Language"
     When I select "English" from "#edit-langcode-0-value"
      And I fill in "Title" with "Test English Landing page title by content admin"
      And I select "published" from "edit-moderation-state-0-state"
      And I press "Save"
      And wait
  ...
  Scenario: Check if a site admin user can Create Basic page with English for the language of the content
    Given I am a logged in user with the "Site admin" user
     ...
     Then I should see "Language"
     When I select "English" from "#edit-langcode-0-value"
      And I fill in "Title" with "Test English Basic page title by site admin"
      And I fill in the rich text editor field "Body" with the "Test English Basic page body"
      And I select "published" from "edit-moderation-state-0-state"
      And I press "Save"
      And wait
  ...
  Scenario: Check if a site admin user can can Create Landing page with English for the language of the content
    Given I am a logged in user with the "Site admin" user
     ...
     Then I should see "Language"
     When I select "English" from "#edit-langcode-0-value"
      And I fill in "Title" with "Test English Landing page title by site admin"
      And I select "published" from "edit-moderation-state-0-state"
      And I press "Save"
      And wait
