  ...
  Scenario: Check the Role Assign configuration
    Given I am a logged in user with the "webmaster" user
     ...
     Then I should see "Role assign"
      And the checkbox labeled "Editor" should be checked
      And the checkbox labeled "Content Admin" should be checked
      And the checkbox labeled "Site Admin" should be checked
