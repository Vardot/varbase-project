  ...
  Scenario: Add Test content N1, N2, N3 type of test content
    Given I am a logged in user with the "webmaster" user
     ...
     When I fill in "Test content N1" for "Title"
      And I fill in the WYSIWYG field "Body" with the "Test content N1 Body"
     ...
     When I fill in "Test content N2" for "Title"
      And I fill in the WYSIWYG field "Body" with the "Test content N2 Body"
      And I select "published" from "edit-moderation-state-0-state"
      And I press the "Save" button
      And wait
     ...
     When I fill in "Test content N3" for "Title"
      And I fill in the WYSIWYG field "Body" with the "Test content N3 Body"
      And I select "published" from "edit-moderation-state-0-state"
      And I press the "Save" button
      And wait
