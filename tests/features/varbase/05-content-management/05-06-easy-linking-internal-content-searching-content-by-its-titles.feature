  ...
  Scenario: Check if inserted raw URL will convert into a link when we save when We are using the Visual editor text format
    Given I am a logged in user with the "Site admin" user
     ...
     When I select "full_html" from "Text format"
      ...
      And I fill in the rich text editor field "Body" with the "Linking to internal content #1 body"
     ...
     When I select "full_html" from "Text format"
      ...
      And I fill in the rich text editor field "Body" with the " Linking to internal content #2 body "
