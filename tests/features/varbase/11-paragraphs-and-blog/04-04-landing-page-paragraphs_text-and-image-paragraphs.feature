...
Feature: Content Structure - Landing page (Paragraphs) - Varbase text and image paragraphs
  ...
  # TODO(10.1.x CI): on Drupal 11.4 the text_and_image paragraph flow emits a
  # page JS error ("Cannot read properties of null (reading 'indexOf')") and the
  # "Text" CKEditor sub-field label is not clickable, timing out the step. Needs
  # a browser to trace the JS source. Un-@wip once fixed.
