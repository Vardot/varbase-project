...
Feature: Content Editing - Rich Text Editor - Easy linking to internal content by searching for content by its titles
  ...
  # TODO(10.1.x CI): on Drupal 11.4 the CKEditor 5 Link (linkit) autocomplete
  # does not surface the internal content title while typing, so the dropdown
  # assertion times out. Needs a browser to verify the linkit interaction. Un-@wip.
