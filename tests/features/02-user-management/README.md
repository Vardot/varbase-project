...
| `02-06-admins-can-create-users-and-assign-role-them.feature` | User Management - Standard User Management - Admins can create users and assign a role to them | 2 |
